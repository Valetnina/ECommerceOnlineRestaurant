...
$app->get('/product/:slug', function($slug) use ($app, $lang) {
    $productRecord = DB::queryFirstRow("SELECT products.ID, price, picture,"
                    . " nutritionalValue, name, description FROM products, "
                    . "products_i18n WHERE  products_i18n.productID = products.ID AND lang=%s AND products_i18n.slugname=%s", $lang, $slug);
