...
";
    ...
    <div class=\"container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 55
            echo "                        <button class=\"list-group-item categoryIdClass\" id=\"";
        ...
        // line 57
        echo "                </div>
                <label id=\"lbVegetarian\" for=\"cbVegetarian\" width=\"50\">Vegetarian</label><br>
                <input id=\"cbVegetarian\" type=\"checkbox\">
            </div>
            ...
            <div class=\"col-md-3 category\">
                ...
                <div class=\"list-group\" id=\"navCategory\">
                    {% for category in categoryList %}
                        <button class=\"list-group-item categoryIdClass\" id=\"{{category.ID}}\">{{ category.name }}</button>
                    {% endfor %}
                </div>
                <label id=\"lbVegetarian\" for=\"cbVegetarian\" width=\"50\">Vegetarian</label><br>
                <input id=\"cbVegetarian\" type=\"checkbox\">
